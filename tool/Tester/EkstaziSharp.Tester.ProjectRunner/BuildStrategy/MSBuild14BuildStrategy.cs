...
{
    public class MSBuild14BuildStrategy : IBuildStrategy
    {
        ...
        public bool Build(string solutionFilePath, string projectFilePath)
        {
            ...
            string msBuildExePath = "C:\\Program Files (x86)\\MSBuild\\14.0\\Bin\\msbuild.exe";

            string buildArtifact = projectFilePath != null ? projectFilePath : solutionFilePath;
            return ProcessUtil.ExecuteProcessNoPoppingConsole(msBuildExePath, buildArtifact + " /maxcpucount");
        }
    }
}