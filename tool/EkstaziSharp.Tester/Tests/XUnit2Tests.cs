...
namespace EkstaziSharp.Tester.Tests
{
    ...
    public class XUnit2Tests
    {
        private static readonly string ProjectRelativePath =
                            IOUtil.GetRelativePath(new DirectoryInfo(CommonPaths.TesterProjectBinDirectory), new DirectoryInfo(CommonPaths.XUnit2TestsDirectory));
        ...
        [Test, TestCaseSource(typeof(XUnit2Tests), "ClassLevelTestConfigurations")]
        public void ClassLevelTests(string configuration)
        {
            TestCommons.RunWithConfiguration(configuration);
        }

        [Test, TestCaseSource(typeof(XUnit2Tests), "MethodLevelTestConfigurations")]
        ...
        public static IEnumerable ClassLevelTestConfigurations
        {
            get
            {
                List<TestCaseData> testDataList = TestCommons.GetTestData(CommonPaths.XUnit2TestsDirectory, ClassLevelConfiguration, "ClassLevel");
        ...
        public static IEnumerable MethodLevelTestConfigurations
        {
            get
            {
                List<TestCaseData> testDataList = TestCommons.GetTestData(CommonPaths.XUnit2TestsDirectory, MethodLevelConfiguration, "MethodLevel");
